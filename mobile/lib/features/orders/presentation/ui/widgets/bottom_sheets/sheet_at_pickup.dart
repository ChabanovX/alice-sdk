...
class SheetAtPickup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const minVisibleHeight = 222.0 + 160;
  ...
  Widget _buildInnerWidget(BuildContext context, ScrollController sc) {
    ...
    final takePassengerBox = SizedBox(
      height: 68,
      child: Row(
        children: [avatarBox, textBox, const Spacer(), arrowBox],
      ),
    );
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            _buildWeirdButton(
                context, 'Сообщение', 'assets/icons/msg_icon.svg'),
            const SizedBox(
              width: 8,
            ),
            _buildWeirdButton(context, 'Звонок', 'assets/icons/phone_icon.svg'),
            const SizedBox(
              width: 8,
            ),
            _buildWeirdButton(
                context, 'Конфликт', 'assets/icons/Flasher_filled.svg'),
            const SizedBox(
              width: 8,
            ),
            _buildWeirdButton(context, 'Отмена', 'assets/icons/no_icon.svg'),
            const SizedBox(
              width: 8,
            ),
          ],
  ...
  Widget _buildWeirdButton(BuildContext context, String title, String path) {
    final grey = Theme.of(context).colorScheme.surfaceDim;
      ...
      child: SizedBox(
        ...
        child: Column(
          children: [
            ...
            Text(
              title,
              style: context.textStyles.mediumSmall,
            ),
          ],
        ),
      ),
